...
exports.apiPageNew = function (request, response, api) {
  const { user, canonicalUrl } = request;
  const title = 'API Reference';
  const htmlReference = api.toHTML();
...
exports.blogPage = function (request, response) {
  const { user, canonicalUrl } = request;
  const title = 'Blog';
...
exports.blogPageNew = function (request, response, blog) {
  const { user, canonicalUrl } = request;
  const title = 'Blog';
...
exports.projectsPageNew = function (request, response) {
  const { user, canonicalUrl } = request;
  const title = 'Projects';
  const projects = db.get('projects');
...
exports.projectPageNew = function (request, response, project) {
  const { user, canonicalUrl } = request;
  const title = project.name;
...
exports.newLoginPage = function (request, response) {
  const { user, canonicalUrl } = request;
  const title = 'Log In';
...
exports.containersPageNew = function (request, response) {
  const { user, canonicalUrl } = request;
...
exports.settingsPage = async function (request, response, section) {
  const { user, canonicalUrl } = request;
...
exports.settingsPageNew = async function (request, response) {
  const { user, canonicalUrl } = request;
  const title = 'Settings';
...
exports.dataPageNew = function (request, response) {
  const { user, canonicalUrl } = request;
  const title = 'Data';
...
exports.notFoundPageNew = function (request, response) {
  const { user, canonicalUrl } = request;
  const title = 'Page not found';
