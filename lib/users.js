  ...
  login.login(function (error, token, session) {
    ...
    var template = {
      ...
      htmlMessage: function (key) {
        ...
        '<p>The Janitor is now in alpha, and you\'re invited!</p>\n' +
        '<p>To activate your free and unlimited account, please follow these steps:\n<ol>' +
        '<li><a href="https://c9.io/web/sign-up/free">' +
          'Click here</a> to create a free Cloud9 account</li>\n' +
        '<li><a href="https://' + host + '/account/?key=' + key + '">' +
          'Click here</a> to create your unlimited Janitor account</li>\n' +
        '<li><a href="https://c9.io/account/ssh">Click here</a> to get your ' +
          'Cloud9 SSH Key, and add it to your Janitor account</li></ol></p>\n' +
        '<p>With that, you\'ll be able to clone and edit all the supported ' +
          'projects, as often and for as long as you like!</p>\n' +
        '<p>Happy hacking,<br>\nThe Janitor</p>\n';
      },
      textMessage: function (key) {
        return 'Congratulations!\n\n' +
        'The Janitor is now in alpha, and you\'re invited!\n\n' +
        'To activate your free and unlimited account, please follow these steps:\n\n' +
        '1. Create a free Cloud9 account by visiting:\n' +
          'https://c9.io/web/sign-up/free\n\n' +
        '2. Create your unlimited Janitor account:\n' +
          'https://' + host + '/account/?key=' + key + '\n\n' +
        '3. Get your Cloud9 Key, and add it to your Janitor account:\n' +
          'https://c9.io/account/ssh\n\n' +
        'With that, you\'ll be able to clone and edit all the supported ' +
