...
function getOrCreateUser (email) {
  ...
  // Temporary migration code: Previous users didn't have configuration
  if (!user.configurations) {
    user.configurations = {};
    for (let configuration in configurations.defaultConfigurations) {
      configurations.resetConfiguration(user, configuration);
    }
  }
...
getOrCreateUser("admin@localhost");