...
exports.pullImage = function (parameters) {
...
exports.inspectImage = function (parameters) {
  const { host, image: imageId } = parameters;
...
exports.tagImage = function (parameters) {
...
exports.removeImage = function (parameters) {
  const { host, image: imageId } = parameters;
...
exports.copyIntoContainer = function (parameters) {
...
exports.listChangedFilesInContainer = function (parameters) {
...
exports.removeContainer = function (parameters) {
  const { host, container: containerId } = parameters;
...
exports.version = function (parameters) {
  const { host } = parameters;
