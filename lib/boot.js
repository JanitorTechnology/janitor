...
function ensureDockerTlsCertificates (next) {
...
exports.ensureDockerTlsCertificates = ensureDockerTlsCertificates;


// Verify OAuth2 client access to a Janitor instance (for cluster hosts).

function verifyJanitorOAuth2Access (next) {
...
exports.verifyJanitorOAuth2Access = verifyJanitorOAuth2Access;
